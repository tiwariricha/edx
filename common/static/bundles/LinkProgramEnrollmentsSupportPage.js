(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([40],{

/***/ "./lms/djangoapps/support/static/support/jsx/program_enrollments/index.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LinkProgramEnrollmentsSupportPage", function() { return LinkProgramEnrollmentsSupportPage; });
...
var LinkProgramEnrollmentsSupportPage = function LinkProgramEnrollmentsSupportPage(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'form',
    { method: 'post' },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'hidden', name: 'csrfmiddlewaretoken', value: __WEBPACK_IMPORTED_MODULE_2_js_cookie___default.a.get('csrftoken') }),
    props.successes.length > 0 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["StatusAlert"], {
      open: true,
      alertType: 'success',
      dialog: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          null,
          'There were ',
          props.successes.length,
          ' successful linkages'
        )
      )
    }),
    props.errors.map(function (errorItem) {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["StatusAlert"], {
        open: true,
        dismissible: false,
        alertType: 'danger',
        dialog: errorItem
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["InputText"], {
      name: 'program_uuid',
      label: 'Program UUID',
      value: props.programUUID
    }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["TextArea"], {
      name: 'text',
      label: 'List of external_user_key, lms_username, one per line',
      value: props.text,
      placeholder: 'external_student_key,lms_username'
    }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["Button"], { label: 'Submit', type: 'submit', className: ['btn', 'btn-primary'] })
  );
};

LinkProgramEnrollmentsSupportPage.propTypes = {
  successes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string),
  errors: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string),
  programUUID: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
...
//# sourceMappingURL=LinkProgramEnrollmentsSupportPage.js.map