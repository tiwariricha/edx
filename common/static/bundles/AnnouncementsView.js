...
/***/ "./openedx/features/announcements/static/announcements/jsx/Announcements.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnnouncementsView", function() { return AnnouncementsView; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnnouncementList", function() { return AnnouncementList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnnouncementSkipLink", function() { return AnnouncementSkipLink; });
...
var AnnouncementSkipLink = function (_React$Component) {
  _inherits(AnnouncementSkipLink, _React$Component);

  function AnnouncementSkipLink(props) {
    _classCallCheck(this, AnnouncementSkipLink);

    var _this = _possibleConstructorReturn(this, (AnnouncementSkipLink.__proto__ || Object.getPrototypeOf(AnnouncementSkipLink)).call(this, props));

    _this.state = {
      count: 0
    };
    __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.get('/announcements/page/1').then(function (data) {
      _this.setState({
        count: data.count
      });
    });
  ...
  _createClass(AnnouncementSkipLink, [{
    key: 'render',
...
Announcement.propTypes = {
  content: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired
};

var AnnouncementList = function (_React$Component3) {
  _inherits(AnnouncementList, _React$Component3);

  function AnnouncementList(props) {
    _classCallCheck(this, AnnouncementList);

    var _this3 = _possibleConstructorReturn(this, (AnnouncementList.__proto__ || Object.getPrototypeOf(AnnouncementList)).call(this, props));
  ...
  _createClass(AnnouncementList, [{
    key: 'retrievePage',
    value: function retrievePage(page) {
      var _this4 = this;

      __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.get('/announcements/page/' + page).then(function (data) {
        _this4.setState({
    ...
    key: 'renderPrevPage',
    value: function renderPrevPage() {
      this.retrievePage(this.state.page - 1);
    }
  }, {
    key: 'renderNextPage',
    value: function renderNextPage() {
      this.retrievePage(this.state.page + 1);
    }
  }, {
    ...
    value: function render() {
      ...
      var children = this.state.announcements.map(function (announcement, index) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Announcement, { key: index, content: announcement.content });
      });
      if (this.state.has_prev) {
        var prev_button = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          null,
      ...
      if (this.state.has_next) {
        var next_button = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          null,
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["Button"], {
            className: ["announcement-button", "next"],
            onClick: function onClick() {
              return _this5.renderNextPage();
            },
            label: 'next \u2192'
          }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
var AnnouncementsView = function AnnouncementsView() {
  _classCallCheck(this, AnnouncementsView);

  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AnnouncementList, null), document.getElementById('announcements'));
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AnnouncementSkipLink, null), document.getElementById('announcements-skip'));
};

/* harmony default export */ __webpack_exports__["default"] = (AnnouncementsView);
...
//# sourceMappingURL=AnnouncementsView.js.map