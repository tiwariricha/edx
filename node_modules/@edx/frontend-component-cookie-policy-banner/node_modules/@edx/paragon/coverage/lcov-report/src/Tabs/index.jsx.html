...
&nbsp;
<span class="fstat-no" title="function not covered" >  to</span>ggle(tab) {
<span class="cstat-no" title="statement not covered" >    if (this.state.activeTab !== tab) {</span>
...
&nbsp;
      return (
        &lt;Button
          ...
          id={labelId}
          key={labelId}
          onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; { <span class="cstat-no" title="statement not covered" >this.toggle(i); </span>}}
