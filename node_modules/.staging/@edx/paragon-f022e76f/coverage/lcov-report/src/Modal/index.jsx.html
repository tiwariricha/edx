...
<span class="cstat-no" title="statement not covered" >    ReactDOM.unmountComponentAtNode(this.parentElement);</span>
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!e || e.target.classList.contains('js-close-modal-on-click')) {
